...
REACT_MEMORY_RERANKER_BATCH_SIZE = int(os.getenv("REACT_MEMORY_RERANKER_BATCH_SIZE", "32"))
...
FULLWIKI_SEARCH_CANDIDATES = int(os.getenv("FULLWIKI_SEARCH_CANDIDATES", "100"))
