...
REACT_SEARCH_TOP_K = int(os.getenv("REACT_SEARCH_TOP_K", "3"))
REACT_MAX_EVIDENCE_DOCUMENTS = int(os.getenv("REACT_MAX_EVIDENCE_DOCUMENTS", "6"))
REACT_MAX_OBSERVATION_CHARS = int(os.getenv("REACT_MAX_OBSERVATION_CHARS", "3600"))
